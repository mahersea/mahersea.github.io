...
- Led comprehensive data persistence infrastructure implementation for a content API, architecting event-driven microservices that enhance content delivery
- Established foundation for $2M+ sports data platform expansion
- Build and maintained a headless CMS architecture.
- Developed NestJS-based RSS feeds for mobile app integration.
- SME on mobile app developement with notifications and in-app-messaging (One Signal)
- Full-stack development with NestJS and NextJS for the primary website and content API
- AWS integration: Lambda, SNS, SQS, RDS, S3 for cloud operations.
...
- Technologies: NestJS, NextJS, TypeScript, React, React Native GraphQL, MongoDB, Mongoose ODM, Stellate, Kinesis, Docker, Redis, Redux
- Core leader and contributor to corporate AI initiatives
