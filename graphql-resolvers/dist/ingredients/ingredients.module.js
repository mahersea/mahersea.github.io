...
const ingredients_resolver_1 = require("./ingredients.resolver");
...
exports.IngredientsModule = IngredientsModule = __decorate([
    (0, common_1.Module)({
        providers: [ingredients_service_1.IngredientsService, ingredients_resolver_1.IngredientsResolver],
